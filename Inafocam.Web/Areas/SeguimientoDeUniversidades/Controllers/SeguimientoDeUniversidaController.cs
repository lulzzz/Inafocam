    ...
    public class SeguimientoDeUniversidaController : Controller
    {
        ...
        public IActionResult Informes(int tracingId,int programUniversityId)
        {
            var model = new InformeIndexViewModel();
               ...
               model.CanAddComment = CanAddComment();
            ...
            ViewBag.Prueba = "olwen";

            return View(model);
        }


        [Authorize(Roles = RoleName.AdministradorInafocam + "," + RoleName.UsuarioEjecutivoInafocam)]
        ...
        public bool CanAddComment()
        {
            ...
            var canIt = user.Role == RoleName.AdministradorInafocam || 
                user.Role == RoleName.UsuarioEjecutivoInafocam ? true : false;
